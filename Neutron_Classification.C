...
void Neutron_Classification( TString myMethodList = "" )
{
  ...
  //
   ...
   TString fname = "./NEUTRON_ACCSINGLES_SB_2500.root";
   ...
   // See TMVAClassification.C for how you can fill a signal/bkg tree "by hand"
   ...
   if (Use["PDERS"])
      factory->BookMethod( TMVA::Types::kPDERS, "PDERS",
                           "!H:!V:NormTree=T:VolumeRangeMode=Adaptive:KernelEstimator=Gauss:GaussSigma=0.3:NEventsMin=1100:NEventsMax=1800" );
   ...
   if (Use["FDA_GA"]) // can also use Simulated Annealing (SA) algorithm (see Cuts_SA options])
      factory->BookMethod( TMVA::Types::kFDA, "FDA_GA",
                           "H:!V:Formula=(0)+(1)*x0+(2)*x1:ParRanges=(-1,1);(-10,10);(-10,10);(-10,10);(-10,10):FitMethod=GA:PopSize=300:Cycles=3:Steps=20:Trim=True:SaveBestGen=1" );
